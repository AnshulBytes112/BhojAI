        ...
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button onClick={exportExcel} style={primaryBtn} onMouseEnter={e => e.currentTarget.style.background='#c2410c'} onMouseLeave={e => e.currentTarget.style.background='#ea580c'} onMouseDown={e => e.currentTarget.style.transform='scale(0.96)'} onMouseUp={e => e.currentTarget.style.transform='scale(1)'}>📥 Export CSV</button>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ alignSelf: 'center' }}>
                        <div style={{ fontSize: 13, color: '#333' }}>{res.dateStr}</div>
                        <div style={{ fontSize: 12, color: '#888', marginTop: 2 }}>{res.timeRange}</div>
                      </div>
                ...
                <div style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'auto' }}>
                  ...
                  <div style={{ background: '#fcfbf9', border: '1px solid #f0ede8', borderRadius: 12, padding: '16px', marginBottom: 20 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                      <div>
                        <div style={{ fontSize: 13, color: '#666', marginBottom: 4 }}>{selectedRes.dateStr}</div>
                        <div style={{ fontSize: 13, color: '#666' }}>{selectedRes.timeRange}</div>
                      </div>
                      <div style={{ fontSize: 13, color: '#666' }}>{selectedRes.tableNumber}</div>
                    </div>
